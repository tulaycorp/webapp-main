...
@section('content')
  <div class="pt-32">
    {{-- Contact Hero --}}
    <section
      class="py-32 px-6 lg:px-8 bg-background dark:bg-gray-800 min-h-[60vh] flex items-center transition-colors duration-300 relative overflow-hidden">
      {{-- Subtle Grid Pattern --}}
    ...
    <section class="py-32 px-6 lg:px-8 bg-background dark:bg-gray-900 transition-colors duration-300">
      <div class="max-w-7xl mx-auto">
        <div class="mb-20">
          ...
          <p data-animate="fade-in" data-delay="200" class="text-xl text-secondary dark:text-gray-400 max-w-2xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <form id="contact-form" class="space-y-10" novalidate>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <input required type="text"
                    class="form-input dark:bg-gray-800 dark:border-gray-700 dark:text-white text-lg py-4" id="first-name"
                ...
                <div>
                  ...
                  <div class="error-message text-red-500 text-[10px] font-bold uppercase tracking-wider mb-2 hidden">
                    Required field</div>
                  <input required type="text"
                    class="form-input dark:bg-gray-800 dark:border-gray-700 dark:text-white text-lg py-4" id="last-name"
              ...
              <div>
                ...
                <input required type="email"
                  class="form-input dark:bg-gray-800 dark:border-gray-700 dark:text-white text-lg py-4" id="email"
              ...
              <div>
                ...
                <select id="topic" name="topic"
                  class="form-input dark:bg-gray-800 dark:border-gray-700 dark:text-white text-lg py-4" required>
              ...
              <div>
                ...
                <textarea required id="message" name="message" rows="8"
                  class="form-input dark:bg-gray-800 dark:border-gray-700 dark:text-white text-lg py-4"
                  placeholder="Tell us about your project or inquiry..."></textarea>
              </div>

              <button data-hover="scale"
                class="btn-primary dark:bg-white dark:text-gray-900 w-full md:w-auto px-16 py-5 text-lg" type="submit">
                Send Message
              </button>
              <div id="contact-success" class="bg-green-500/10 border-l-4 border-green-500 p-6 mt-8 hidden">
                <p class="text-green-600 dark:text-green-400 uppercase text-base tracking-wider">✓ Message sent
                  successfully! We'll respond within 24 hours.</p>
              </div>
            </form>
          </div>
          ...
          <div class="space-y-8" data-animate="slide-left" data-delay="300">
            ...
            <div class="modern-card dark:bg-gray-800 dark:border-gray-700 p-10">
              <h3 class="text-3xl uppercase tracking-tight text-primary dark:text-white font-impact mb-8">Contact Info
              </h3>
              <p class="text-secondary dark:text-gray-400 text-lg mb-10 leading-relaxed">Reach out to us through any of
                these channels. We're here to help!</p>
              <ul class="space-y-8">
                <li class="flex items-start gap-5 group cursor-pointer">
                  <div
                    class="w-16 h-16 border-2 border-primary dark:border-white text-primary dark:text-white flex items-center justify-center flex-shrink-0 group-hover:bg-primary dark:group-hover:bg-white transition-all shadow-md">
                    <i data-lucide="mail"
                      class="w-8 h-8 group-hover:text-white dark:group-hover:text-gray-900 transition-colors"></i>
                  </div>
                  <div>
                ...
                <li class="flex items-start gap-5 group cursor-pointer">
                  ...
                  <div>
                    ...
                    <p class="text-primary dark:text-white text-lg font-medium">Monday – Friday<br />9:00 AM – 5:00 PM EST
                    </p>
                  </div>
                </li>
              </ul>
    ...
    <section class="py-32 px-6 lg:px-8 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div class="max-w-4xl mx-auto">
        <div class="text-center mb-20">
          ...
          <p data-animate="fade-in" data-delay="200" class="text-xl text-secondary dark:text-gray-400">
        ...
        <div class="space-y-6">
          <div class="modern-card dark:bg-gray-700 dark:border-gray-600 p-8" data-animate="fade-in" data-delay="0">
            ...
            <p class="text-secondary dark:text-gray-400 text-lg leading-relaxed">Standard shipping takes 3-5 business days
              within the US. International shipping varies by location, typically 7-14 business days.</p>
          </div>
          <div class="modern-card dark:bg-gray-700 dark:border-gray-600 p-8" data-animate="fade-in" data-delay="100">
            ...
            <p class="text-secondary dark:text-gray-400 text-lg leading-relaxed">We offer a 30-day money-back guarantee on
              all products. Items must be unworn, unwashed, and in original condition with tags attached.</p>
          </div>
          <div class="modern-card dark:bg-gray-700 dark:border-gray-600 p-8" data-animate="fade-in" data-delay="200">
            ...
            <p class="text-secondary dark:text-gray-400 text-lg leading-relaxed">Yes! We work with select retailers and
              boutiques. Contact us at wholesale@framework.co for more information about bulk orders.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-32 px-6 lg:px-8 bg-primary dark:bg-white transition-colors duration-300">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p data-animate="fade-in" data-delay="200" class="text-xl text-white/80 dark:text-gray-600 mb-12">
          Get the latest updates, exclusive offers, and street culture news
        </p>
        <div data-animate="fade-in" data-delay="400" class="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
          ...
          <button
            class="bg-white dark:bg-gray-900 text-primary dark:text-white px-12 py-5 text-lg uppercase tracking-wider font-medium hover:bg-white/90 dark:hover:bg-gray-800 transition-all shadow-xl hover:shadow-2xl">
            Subscribe
          </button>
        </div>
      </div>
