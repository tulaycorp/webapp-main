      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item position-relative"><a class="nav-link" href="cart.html" data-page="cart">🛒 Cart <span class="badge bg-primary ms-1" id="cart-count">0</span></a></li>
        ...
        <div class="modal-content shadow-lg border-0">
          ...
          <div class="modal-body p-4">
            <form id="signup-form" novalidate>
              <div class="mb-3">
                <label for="signup-name" class="form-label fw-semibold text-dark">
                  <i class="bi bi-person me-1"></i>Full Name
                </label>
                <input id="signup-name" name="name" type="text" class="form-control form-control-lg" required 
                       placeholder="Enter your full name" minlength="2" maxlength="50"
                       pattern="[a-zA-Z\s\-']{2,50}"
                       oninput="this.value = this.value.replace(/[^a-zA-Z\s\-']/g, '')"
                       autocomplete="name">
                <div class="invalid-feedback">
                  <i class="bi bi-exclamation-circle me-1"></i>Please enter your full name (2-50 characters)
                </div>
              </div>
              <div class="mb-3">
